...
namespace MathLibrary
{
    public class Matrix3
    {
        ...
        public Vector3 Position
        {
            ...
            set { m13 = value.X; m23 = value.Y; }
        }
        public Vector3 Direction
        {
            get { return new Vector3((float)Math.Sqrt(m11 * m11 + m21 * m21), (float)Math.Sqrt(m12 * m12 + m22 * m22), 0); }
        }
        public void Rotation(float m11, float m21, float m12, float m22)
        {
